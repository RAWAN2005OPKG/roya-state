...
return new class extends Migration {
    public function up(): void {
        Schema::create('wali_voucher_details', function (Blueprint $table) {
            $table->id();
            $table->foreignId('wali_voucher_id')->constrained('wali_vouchers')->onDelete('cascade');
            $table->string('cash_source_name')->nullable(); // حقل نصي
    ...
    public function down(): void { Schema::dropIfExists('wali_voucher_details'); }
};
