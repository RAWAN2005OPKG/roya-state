...
use App\Models\Supplier; // **هذا هو الاستيراد الضروري**
...
class ProductController extends Controller
{
    ...
    {
        // **هذه هي الدالة التي تحل مشكلة $suppliers**
        $suppliers = Supplier::all();
        // يمكنك إضافة فئات أو أي بيانات أخرى هنا
