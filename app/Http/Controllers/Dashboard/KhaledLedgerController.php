...
class KhaledLedgerController extends VoucherController
{
    private $ledgerName = 'khaled';
    private $routeName = 'dashboard.khaled-ledger';
    private $pageTitle = 'دفتر أستاذ: خالد';
    ...
    public function create()
    {
        ...
        return view('dashboard.ledgers.create', [
            ...
            'projects' => $projects,
            'pageTitle' => 'إنشاء سند جديد لحساب: خالد',
            'routeName' => $this->routeName,
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $validatedData['serial_number'] = 'KLD-' . time(); // رقم تسلسلي خاص بخالد
    ...
    public function edit($id)
    {
        ...
        return view('dashboard.ledgers.edit', [
            ...
            'bankAccounts' => $bankAccounts,
            'projects' => $projects,
            'pageTitle' => 'تعديل سند لحساب: خالد',
            'routeName' => $this->routeName,
        ]);
    }
