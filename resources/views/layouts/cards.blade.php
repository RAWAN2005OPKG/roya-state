...
<!--end::Row-->
    ...
    <script src="{{asset("dashboard/assets/plugins/custom/flot/flot.bundle.js")}}"></script>
    <script src="{{asset("dashboard/assets/js/pages/features/charts/flotcharts.js")}}"></script>
