...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>Metronic | Projects</title>
		<meta name="description" content="Projects page example" />
		<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
		<!--begin::Fonts-->
		<link rel="stylesheet" href="{{asset('dashboard/https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700')}}"  />
		<!--end::Fonts-->
		...
		<script src="{{asset('dashboard/assets/js/pages/custom/projects/list-datatable.js') }}"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>
