        ...
        <form action="{{ route('dashboard.investments.store') }}" method="POST">
            ...
            <div class="form-section">
                ...
                <div class="row">
                    ...
                    <div class="col-12 form-group mb-4">
                        ...
                        @php
                            $paymentMethods = explode(',', old('payment_method', ''));
                        @endphp
            ...
            <div id="cash-details" class="form-section hidden">
                ...
                <div class="row">
                    <div class="col-md-4 form-group mb-3">
                        <label>من استلم المبلغ</label>
                        <input type="text" name="cash_receiver" class="form-control" value="{{ old('cash_receiver') }}">
                    </div>
                    <div class="col-md-4 form-group mb-3">
                        <label>وظيفة المستلم</label>
                        <input type="text" name="cash_receiver_job" class="form-control" value="{{ old('cash_receiver_job') }}">
                    </div>
                    <div class="col-md-4 form-group mb-3">
                        <label>تاريخ الاستلام</label>
                        <input type="date" name="cash_receipt_date" class="form-control" value="{{ old('cash_receipt_date') }}">
                    </div>
                </div>
            </div>
            ...
            <div id="bank-details" class="form-section hidden">
                ...
                <div class="row">
                    <div class="col-md-6 form-group mb-3">
                        ...
                        <input type="text" name="sender_bank" class="form-control" value="{{ old('sender_bank') }}">
                    </div>
                    <div class="col-md-6 form-group mb-3">
                        <label>البنك المستقبل</label>
                        <input type="text" name="receiver_bank" class="form-control" value="{{ old('receiver_bank') }}">
                    </div>
                    <div class="col-md-6 form-group mb-3">
            ...
            <div id="check-details" class="form-section hidden">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 form-group mb-3">
                        <label>اسم مالك الشيك</label>
                        <input type="text" name="check_owner" class="form-control" value="{{ old('check_owner') }}">
                    </div>
                    <div class="col-md-4 form-group mb-3">
                        <label>البنك المسحوب عليه</label>
                        <input type="text" name="check_bank" class="form-control" value="{{ old('check_bank') }}">
                    </div>
                    <div class="col-md-4 form-group mb-3">
                        <label>تاريخ الاستحقاق</label>
                        <input type="date" name="check_due_date" class="form-control" value="{{ old('check_due_date') }}">
                    </div>
                </div>
            </div>
