        ...
        <form action="{{ route('dashboard.investments.store') }}" method="POST">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="payment_method" name="payment_method" value="{{ old('payment_method') }}" placeholder="كاش، شيك، تحويل...">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="other_bank_name">اسم بنك آخر (إذا لم يكن في القائمة)</label>
                    <input type="text" id="other_bank_name" name="other_bank_name" value="{{ old('other_bank_name') }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="contract_id" name="contract_id" value="{{ old('contract_id') }}">
                </div>
